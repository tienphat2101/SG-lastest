...
const EditProfileModal = ({ authUser }) => {
  ...
  return (
    <>
      <button
        className="button flex justify-center items-center px-3 py-1.5 gap-2 h-9 w-30 border-none rounded-full cursor-pointer bg-[#87df2c1a] hover:bg-[#87df2c66]"
        onClick={() =>
          document.getElementById("edit_profile_modal").showModal()
        }
      >
        <span className="lable text-[#87df2c] text-base font-sans tracking-wide">
          Edit profile
        </span>
        <svg className="svg-icon w-5 h-5 fill-[#87df2c]" viewBox="0 0 20 20">
