    ...
    <div className="max-w-screen-xl mx-auto flex h-screen px-10 bg-gray-900">
      ...
      <div className="flex-1 flex flex-col justify-center items-center">
        ...
        >
          ...
          <label className="input input-bordered rounded flex items-center gap-2 bg-gray-800 text-white">
            <MdOutlineMail />
            <input
              type="email"
          ...
          <div className="flex gap-4 flex-wrap">
            <label className="input input-bordered rounded flex items-center gap-2 flex-1 bg-gray-800 text-white">
              <FaUser />
              <input
                type="text"
                className="grow bg-transparent"
          ...
          <button className="btn rounded-full bg-teal-600 text-white hover:bg-teal-700">
            {isPending ? "Loading..." : "Sign up"}
          </button>
          {isError && <p className="text-red-500">{error.message}</p>}
        </form>
        <div className="flex flex-col lg:w-2/3 gap-2 mt-4">
          <p className="text-gray-300 text-lg">Already have an account?</p>
          <Link to="/login">
            <button className="btn rounded-full bg-gray-700 text-white hover:bg-gray-600 btn-outline w-full">
              Sign in
            </button>
          </Link>
        </div>
